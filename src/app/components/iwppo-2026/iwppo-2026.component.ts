...
const fallbackUi: Record<Language, IwppoPageData['ui']> = {
  pt: {
    ...
    labels: {
      grade: 'Conceito',
      edition: 'Edição',
      programmingDays: 'Dias de programação',
      speakers: 'Palestrantes',
      thematicAxes: 'Eixos temáticos',
      panAmazonTerritories: 'Países e territórios da Pan-Amazônia',
      lattes: 'Lattes',
  ...
  en: {
    ...
    labels: {
      grade: 'Grade',
      edition: 'Edition',
      programmingDays: 'Program days',
      speakers: 'Speakers',
      thematicAxes: 'Thematic axes',
      panAmazonTerritories: 'Pan-Amazon countries and territories',
      lattes: 'Lattes',
  ...
  es: {
    ...
    labels: {
      grade: 'Concepto',
      edition: 'Edición',
      programmingDays: 'Días de programa',
      speakers: 'Ponentes',
      thematicAxes: 'Ejes temáticos',
      panAmazonTerritories: 'Países y territorios de la Panamazonía',
      lattes: 'Lattes',
...
export class Iwppo2026Component implements OnInit, AfterViewInit, OnDestroy {
  ...
  readonly partners: Partner[] = [
    { name: 'Universidade Santa Cecília (UNISANTA)', logo: 'assets/images/logos-leves/unisanta.jpeg', category: 'organizer' },
    {
